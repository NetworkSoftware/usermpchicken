...
public class HeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        phrase1.add("");
        Chunk chunk1 = new Chunk("freshcatch@gmail.com", webPrint);
        chunk1.setAnchor("https://mail.google.com/mail/u/0/?tab\\u003drm\\u0026ogbl#inbox?compose\\u003dnew");
        phrase1.add(chunk1);

      /*  Phrase phrase2 = new Phrase();
        phrase2.add("");
        Chunk chunk2 = new Chunk("www.chennaifresh.com", webPrint);
        chunk2.setAnchor("https://www.chennaifresh.com/#");
        phrase2.add(chunk2);
*/
        ...
        /*ColumnText.showTextAligned(writer.getDirectContent(),
                Element.ALIGN_RIGHT, new Phrase("For " + "Chennai Fresh" + " ", PagenoFont1),
