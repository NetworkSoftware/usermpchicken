...
import static pro.network.mpchicken.app.AppConfig.ADDRESS;
...
public class AddAddressActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private void validatePincode(final ProgressBar progressBar,
        ...
        StringRequest strReq = new StringRequest(GET,
                AppConfig.PINCODE + "/" + addressTxt.getText().toString(),
    ...
    private void updateAddress(Address address1, boolean isUpdate) {
       ...
       if (isUpdate) {
        ...
        StringRequest strReq = new StringRequest(method, addAddress, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                hideDialog();
