        ...
        ((LinearLayout) findViewById(R.id.whatsapp)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (getCallingActivity() != null &&
                        getCallingActivity().getPackageName().equals("pro.network.spirtual")) {
                    try {
                        Intent intent = new Intent(Intent.ACTION_VIEW);
                        intent.setData(Uri.parse("http://api.whatsapp.com/send?phone=919025865487"
                                + "&text=" + "Hi 18 Sithras Spritual, I would like buy this " + getIntent().getStringExtra("description") + " Place"));
