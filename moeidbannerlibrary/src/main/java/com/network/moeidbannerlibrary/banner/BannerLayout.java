...
import com.network.moeidbannerlibrary.banner.layoutmanager.BannerLayoutManager;
import com.network.moeidbannerlibrary.banner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected class IndicatorAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams(15,
                   15);
